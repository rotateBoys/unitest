...
void move(adventure *com, float *x, float *y, float a);
void move1(adventure *com, float *x, float *y, float a);
void move2(adventure *com, float *x, float *y, float a);
void move3(adventure *com, float *x, float *y, float a);
