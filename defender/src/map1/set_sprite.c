...
void set_bande(adventure *adv, button *ptr)
{
    ...
    sfSprite_setScale(adv->tower_s[0], (sfVector2f){0.6, 0.6});
...
void set_tower1(adventure *adv, button *ptr)
{
    ...
    sfSprite_setScale(adv->tower_s[1], (sfVector2f){0.8, 0.8});
...
void set_tower2(adventure *adv, button *ptr)
{
    ...
    sfSprite_setScale(adv->tower_s[2], (sfVector2f){0.8, 0.8});
    sfSprite_setPosition(adv->tower_s[2], (sfVector2f) {500, 30});
}
...
void set_tower3(adventure *adv, button *ptr)
{
    ...
    sfSprite_setScale(adv->tower_s[3], (sfVector2f){0.8, 0.8});
    sfSprite_setPosition(adv->tower_s[3], (sfVector2f) {600, 30});
}
...
void set_tower4(adventure *adv, button *ptr)
{
    ...
    sfSprite_setScale(adv->tower_s[4], (sfVector2f){0.8, 0.8});
    sfSprite_setPosition(adv->tower_s[4], (sfVector2f) {700, 20});
}
